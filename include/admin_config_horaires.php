...
<?php
  ...
  for ($i = 1 ; $i < 8 ; $i++)
  {
    ...
    $table .= "<select  name=\"".$i."-h1begin\">".$H."</select> <b>à</b> " ;
    // H1 end
    // tableau des heures
       $H = "" ;
       $H .= "<option value=\"\"></option>\r\n" ;
    ...
    $table .= "<select name=\"".$i."-h2begin\">".$H."</select> <b>à</b> " ;
    // H2 end
    // tableau des heures
       $H = "" ;
       $H .= "<option value=\"\"></option>\r\n" ;
//            $H .= "<option value=\"\">Ferm&eacute;</option>\r\n" ;
  ...
  $table .= "<tr><td colspan=\"3\"><span style=\"font-size:10px;\">* La modification des horaires peut entrainer des problèmes au niveau des reservations de machines et des statistiques d'occupation.</span>  <div class=\"box-footer\">
...
<div class="col-md-6">	
	...
	<div class="box-body">
		<form method="post" action="index.php?a=42">
		<!-- Paramétrages du planning des réservations -->
		<div class="form-group">
			<label>Unité de temps (min): <small class="badge bg-blue" data-toggle="tooltip" title="Pour le planning des réservations, la plus petite portion de temps à accorder par tranche de 5, 10, x minutes..."><i class="fa fa-info"></i></small></label>
			...
			<label>Durée maximum (min): <small class="badge bg-blue" data-toggle="tooltip" title="Dur&eacute;e maximum de la r&eacute;servation d'un poste par personne "><i class="fa fa-info"></i></small></label>
		...
		<!-- Paramétrages de la réservation rapide -->
			<div class="form-group">
			<label>Activer la réservation rapide ?</label>
				<?php
			...
			<div class="form-group">
			<label>Sélectionnez la durée par défaut pour la réservation rapide</label>
...
<input type="hidden" name="epnr" value="<?php echo $epn; ?>">
	...
	<br><div style="font-size:10px;">Cliquez sur un jour pour le rendre ferié(inaccessible au public) et vice versa pour le rendre ouvré.</div>
    </div>
