...
$mes_5  ="<div class=\"alert alert-warning alert-dismissable\"><i class=\"fa fa-warning\"></i>
          <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">&times;</button>Le login choisi existe deja</div>";
// admin_user.php
...
$mes_10 ="<div class=\"alert alert-warning alert-dismissable\"><i class=\"fa fa-warning\"></i>
          <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">&times;</button>Aucune nouvelle n'a &eacute;t&eacute; publi&eacute;e</div>";
//admin_materiel.php
...
$mes_15 = "<div class=\"alert alert-info alert-dismissable\"><i class=\"fa fa-info\"></i>
          <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">&times;</button>Le jour surligné à été reinitialisé car il contenait une incompatibilité.</div>" ;
...
$mes_17 = "<div class=\"alert alert-info alert-dismissable\"><i class=\"fa fa-info\"></i>
          <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">&times;</button>aucun pret de cable enregistre</div>" ;
//admin form user
$mes_18= "<div class=\"alert alert-success alert-dismissable\"><i class=\"fa fa-check-square\"></i>
          <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">&times;</button>Nouvel adhérent inséré dans la base</div>" ;
//table des resas
$mes_19= "<div class=\"alert alert-warning alert-dismissable\"><i class=\"fa fa-info\"></i>
          <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">&times;</button>L\'espace est fermé ce jour la.</div>" ;


// post_atelier -> form_atelier
$mes_20 = "<div class=\"alert alert-success alert-dismissable\"><i class=\"fa fa-check-square\"></i>
          <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">&times;</button>Sujet d'atelier enregistré</div>" ;
...
$mes_32="<div class=\"alert alert-warning alert-dismissable\"><i class=\"fa fa-check-square\"></i>
          <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">&times;</button>Tarif ajouté</div>" ;

$mes_33="<div class=\"alert alert-success alert-dismissable\"><i class=\"fa fa-check-square\"></i>
          <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">&times;</button>Tarif modifié</div>" ;

$mes_34="<div class=\"alert alert-warning alert-dismissable\"><i class=\"fa fa-check-square\"></i>
          <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">&times;</button>Tarif supprimé</div>" ;
///geston des forfaits
...
$mes_42= "<div class=\"alert alert-success alert-dismissable\"><i class=\"fa fa-check-square\"></i>
          <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">&times;</button>Fiche adhérent modifiée</div>" ;
