...
<div class="box-tools pull-right">
        ...
        <a href="index.php?a=15"><button class="btn btn-default btn-sm"  data-toggle="tooltip" title="créer un sujet"><i class="fa  fa-plus"></i></button></a>
  ...
  <?php if($_SESSION["status"]==3){ ?>  
        <div class="btn-group">
            <button type="button" class="btn btn-default btn-sm" data-toggle="dropdown" title="vue"><i class="fa fa-eye"></i></button>
                ...
                <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a href="index.php?a=11&c=3">Ateliers du réseau</a></li>
	...
	if ($nba>0)
          ...
          <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">&times;</button>aucune formation programmée</div></br>";
			}
		echo "</div></div>" ;
...
<div class="box box-success"> 
	...
	<div class="box-body"><table class="table table-condensed"><thead>
		...
		echo "<div class=\"alert alert-info alert-dismissable\" id=\"nextyear\" class=\"fade\"><i class=\"fa fa-warning\"></i>
          <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">&times;</button>aucune formation programmée pour l'année prochaine</div>";
		  }
