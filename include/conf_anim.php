...
if ($_SESSION["status"]==3)
{
  switch ($a)
  {
	...
	// Réservations antérieurs a entrer
	case 19:
    ...
    break;
	case 34:
         $titre="Création des sujets des sessions";
         $aide="Création des sessions dans la base";
	...
	//creation d'un animateur form simplifié // modification des profils anim
	 case 51: 
	switch ($b)
	{
		case 1:
