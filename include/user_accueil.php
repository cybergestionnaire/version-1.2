...
//liste des ateliers/evenements de la journee
 ...
 if (mysqli_num_rows($majadh)==0){
	...
	if($updateA<>FALSE){ //maj type 1 == update tab_user
		$logadh=addLog(date('Y-m-d H:i'),"adh",'1','Mise à jour des adhesions adherents du jour');
		}
...
<?php
//*****   Mises à jour des adhérents dont le forfait arrive a expiration ///
 
if ($logadh==TRUE){ echo '<div class="col-md-4"> <div class="alert alert-success alert-dismissable"><i class="fa fa-check-square"></i>
          <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Mise à jour des adhérents effectuée. '.$updateA.' adhérents inactifs !</div></div>';}
...
if($version<>$newversion){ ?>
 <!--DIV Mises à jour -->
  <div class="col-md-4"><div class="box box-danger"><div class="box-header"> <i class="fa fa-warning"></i><h3 class="box-title">Mise à jour de version</h3></div>
	<div class="box-body">
	Une nouvelle version demande bien quelques efforts, cliquez sur le bouton ci-dessous pour faire la mise à jour immédiatement !
	</div>
	 <div class="box-footer"><a href="index.php?a=61"><input type="submit" name="mises à jour" value="Faire la mise à jour" class="btn btn-danger"></a>
			</div>
 </div></div>
 <!-- / MAJ -->
 <?php 
...
if(TRUE==getLogBackup()){
	...
	?>
	<div class="col-md-4"><div class="box box-danger"><div class="box-header"> <i class="fa fa-warning"></i><h3 class="box-title">Sauvegarde de la base de donnée</h3></div>
	<div class="box-body">
		Cela fait un mois que la base de donnée n'a pas été sauvegardée, cliquez sur le bouton pour la lancer !
	</div>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
								...
								?>
                  <span class="info-box-text">Ateliers programmés<br>(ce mois)</span>
...
<div class="box"><div class="box-header"><h3 class="box-title">Au programme cette semaine à l'EPN</h3></div>
		<div class="box-body">
			 <!-- The time line -->
				...
				<ul class="timeline"><li class="time-label"><span class="bg-red">&nbsp;<?php echo getDayFr($dateAS); ?>&nbsp;&nbsp;<i class="fa fa-clock-o"></i>&nbsp;<?php echo $heureAS; ?></span></li><!-- /.timeline-label -->
					<li><i class="fa fa-keyboard-o bg-green"></i>
						<div class="timeline-item"><h3 class="timeline-header"><?php echo $titre; ?></h3>
							...
							<small class="badge bg-purple"><?php echo $inscrits; ?></small>&nbsp;&nbsp;Participants enregistrés<br>
							...
							<div class='timeline-footer'>
								<a href="<?php echo $urlAS; ?>" class="btn btn-success btn-xs">Voir le détail</a>
							</div>
						</div>
					</li>
   ...
   <div class="box-body"> <div class="direct-chat-messages">
       <!-- chat item -->
		...
		for ($i=1; $i<=$nb; $i++){
			...
			$datemes=date_format(date_create($rowmessage['mes_date']), '\l\e d/m/y \à G:i ');
...
<div class="box"><div class="box-header"><h3 class="box-title">Raccourcis</h3></div>
		<div class="box-body">
			<a class="btn btn-app" href="index.php?a=1"><i class="fa fa-group"></i>Adhérents</a>
			<a class="btn btn-app" href="index.php?a=1&b=1"><i class="fa fa-user"></i>+ Adhérent</a>
...
// bouton envoyer message à animateur
...
<div class="box"><div class="box-header"><h3 class="box-title">Au programme cette semaine à l'EPN</h3></div>
		<div class="box-body">
			...
			if($nbe>0){	
				...
				?>
							<!-- timeline time label -->
				<ul class="timeline"><li class="time-label"><span class="bg-red"> <?php echo getDayFr($dateAS); ?> à <?php echo $heureAS; ?></span></li><!-- /.timeline-label -->
					<li><i class="fa fa-keyboard-o bg-green"></i>
						<div class="timeline-item"><h3 class="timeline-header"><?php echo $titre; ?></h3>
