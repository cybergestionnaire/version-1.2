...
Mettre % des sesions/ateliers annulés !!
...
<div class="box box-primary">
	...
	<label>Changer d'année&nbsp;&nbsp;&nbsp;</label>
		...
		//annee en cours
		echo '<a href="index.php?a=5&b=5&year='.date('Y').'&month='.date('m').'"> <button class="btn bg-maroon"> Année en cours</button></a>';
		?>
        </div>
	</div><!-- /.box-body-->
</div><!-- /.box -->
...
<div class="box box-primary">
          <div class="box-header"><i class="fa fa-bar-chart-o"></i><h3 class="box-title">Les sessions pour l'année <?php echo $year; ?></h3></div>
	<div class="box-body">
<?php 
	...
	//debug($toutatelier);
	?>
	Nombre de sessions programmées : <b><?php echo $toutsession["nbsession"]; ?></b></br>
	Nombre des présents : <b><?php echo $toutsession["presents"]; ?></b></br>
...
<div class="box box-primary">
          <div class="box-header"><i class="fa fa-bar-chart-o"></i><h3 class="box-title">Fréquentation des sessions (année <?php echo $year; ?>)</h3></div>
	<div class="box-body">
		<table class="table"> 
				<thead><tr>
					<th>Titre</th> 
...
<!-- nombre de sessions programmées par catégorie, fréquentation -->
<div class="box box-primary">
          <div class="box-header"><i class="fa fa-bar-chart-o"></i><h3 class="box-title">Classement des sessions par catégories</h3></div>
<div class="box-body">
...
?>
<div class="box box-primary">
          <div class="box-header"><i class="fa fa-bar-chart-o"></i><h3 class="box-title">Détail d'une session <?php echo $titresession; ?></h3></div>
<div class="box-body">
<table class="table"> 
				<thead><tr>	<th>date</th> 
					<th>Inscrits</th>
